...
- **ОСТАВЛЯЙ РЕЗЕРВ: 30-40 USDT** на лучшие возможности
...
- Не покупай, если:
  ...
  - последняя сделка была < 3 минут назад (более частые сделки)
  - последние 5 сделок убыточны → пауза на 30 минут (быстрее возвращаемся)
- **Минимальный размер сделки: 10 USDT** - не торгуй мелочью!
...
- **БЫСТРЕЕ ВОЗВРАЩАЙСЯ** в торговлю после убытков (30 минут)
- **ПРИ ВЫСОКОЙ ВОЛАТИЛЬНОСТИ** — используй большие TP (5-10%)
- **ПРИ СТАБИЛЬНОМ РЫНКЕ** — более частые сделки с меньшими TP
